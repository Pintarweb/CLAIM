      ...
      <div className="max-w-3xl w-full text-center">
        ...
        <div className="flex flex-col gap-10 mb-12 relative z-10 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-white to-slate-50 rounded-3xl p-8 border border-slate-200 shadow-xl shadow-slate-200/30 text-left relative overflow-hidden group/container">
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-blue-50 to-indigo-50/20 rounded-full blur-3xl opacity-50 -z-10 group-hover/container:opacity-80 transition-opacity"></div>
            ...
            <div className="flex justify-between items-center mb-8 relative z-10">
              ...
              <button
                ...
                disabled={isZipping}
                className="text-[10px] font-black text-white bg-slate-900 hover:bg-blue-600 px-3 py-2 rounded-lg transition-all shadow-md active:scale-95 uppercase tracking-widest disabled:opacity-50 flex items-center space-x-1.5"
              >
                {isZipping ? (
                  <>
            ...
            <div className="grid md:grid-cols-3 gap-6 relative z-10">
              {DOCUMENTS.map((doc) => (
                <div key={doc.baseName} className="group relative flex flex-col p-5 bg-white rounded-2xl border border-slate-200 hover:border-blue-300 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden text-center h-full">
                  <div className="absolute inset-0 bg-gradient-to-b from-blue-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
                  ...
                  <div className="flex flex-col items-center w-full z-10 mb-5">
                    ...
                    <div className="flex-grow flex flex-col justify-center">
                      <span className="text-slate-900 font-extrabold text-sm leading-snug block group-hover:text-blue-700 transition-colors mb-1">{doc.title}</span>
                  ...
                  <div className="flex items-center space-x-2 w-full mt-auto z-10 relative">
                    ...
                    <button
                      ...
                      className="flex-1 py-2.5 bg-white border border-blue-200 hover:border-blue-300 hover:bg-blue-50 text-blue-600 rounded-lg text-[11px] font-black transition-all shadow-sm hover:shadow active:scale-95 flex items-center justify-center space-x-1.5"
          ...
          <div className="bg-blue-600 rounded-3xl p-8 md:p-12 text-white text-left relative overflow-hidden shadow-2xl shadow-blue-600/20">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-500/40 rounded-full blur-3xl -translate-y-1/4 translate-x-1/4"></div>

            <div className="grid md:grid-cols-5 gap-10 items-center relative z-10">
              <div className="md:col-span-2">
                <h3 className="text-[11px] font-black uppercase tracking-widest text-blue-200 mb-5 flex items-center gap-2">
                  <span className="w-5 h-5 rounded-full bg-blue-500/50 flex items-center justify-center text-white">2</span>
              ...
              <div className="md:col-span-3 bg-blue-700/30 p-8 rounded-2xl border border-blue-500/30 shadow-xl backdrop-blur-sm">
                {hasApplied ? (
                  ...
                  <>
                    <div className="space-y-6 mb-8">
                      <div className="flex items-start">
                        <div className="bg-blue-500 w-10 h-10 rounded-xl flex items-center justify-center mr-4 shrink-0 shadow-inner">
                        ...
                        <div>
                          ...
                          <span className="text-sm text-blue-100/90 leading-relaxed block mt-1.5">Our AI validates Proof, Intent, and Eligibility instantly, saving you hours every month.</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <span className="text-sm text-blue-100/90 leading-relaxed block mt-1.5">Get lifetime access at our lowest early-bird pricing and direct access to our engineering team.</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-2 border-t border-blue-500/30">
                      <button
                        ...
                        disabled={isApplying}
                        className="w-full mt-6 py-4.5 font-black text-[17px] rounded-xl transition-all shadow-lg active:scale-[0.98] flex justify-center items-center bg-white text-blue-600 hover:bg-blue-50 hover:-translate-y-0.5"
                      >
                        {isApplying ? (
                      ...
                      <p className="text-center text-blue-200 text-[10px] uppercase font-black tracking-widest mt-4">Limited spots available for 2026</p>
                    </div>
                  </>
                )}
              </div>
